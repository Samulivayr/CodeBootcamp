...
const FreeWorkers = (props) => {
    ...
    const employeesColumns = [
        ...
        { field: 'etunimi', headerName: 'Etunimi', width: 250, headerClassName:"header" },
        { field: 'sukunimi', headerName: 'Sukunimi', width: 250, headerClassName:"header" },
        { field: 'nimike', headerName: 'Nimike', width: 250, headerClassName:"header" },
        {
            field: 'e',
